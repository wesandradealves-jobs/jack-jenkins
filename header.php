...
<head>
    ...
    <meta name="DC.publisher" content="Gabriel de Gennaro - http://www.gabrieldegennaro.com.br" />
    ...
    ?>>
        <div id="wrap">
            <header>
                <div id="header">
                    <div class="container">
                        <a class="col-lg-3 col-md-9 col-sm-9 col-xs-9 logo" href="<?php echo site_url(); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) )." - ".get_bloginfo('description'); ?>">
                        <?php 
                        ...
                        <nav class="col-lg-9 col-md-3 col-sm-3 col-xs-3">
                            <ul class="pull-right">
                                <?php wp_nav_menu( array( 'container' => false, 'walker' => new description_walker(), 'menu' => 'Header', 'items_wrap' => '%3$s' ) ); ?>                                
                                <li class="hidden-lg">
                ...
                <nav id="mobileNavigation" class="hidden-lg text-center">
                    <ul>
                        <?php wp_nav_menu( array( 'container' => false, 'walker' => new description_walker(), 'menu' => 'Mobile', 'items_wrap' => '%3$s' ) ); ?>
                    </ul>
                </nav>
            </header>