...
$wp_customize->add_setting( 'google-analytics' );
$wp_customize->add_control('google-analytics',  array(
...
wp_enqueue_script('owl-carousel', ("https://owlcarousel2.github.io/OwlCarousel2/assets/owlcarousel/owl.carousel.min.js"));
...
acf_add_options_page(array(
		'page_title' 	=> 'Jack Jenkins',
		'menu_title'	=> 'Jack Jenkins<br>Settings',
		'menu_slug' 	=> 'jack-jenkins',
...
update_option( 'siteurl', 'http://localhost/wip/jack_jenkins/' );
update_option( 'home', 'http://localhost/wip/jack_jenkins/' );
